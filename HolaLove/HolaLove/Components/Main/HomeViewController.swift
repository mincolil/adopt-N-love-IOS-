...
//    var tabHeaderUIView : [HalfRoundedUIView] = []
    ...
    func initView() {
        ...
        gradient.colors = [UIColor(named: "HomeBackground1")?.cgColor,UIColor(named: "HomeBackground2")?.cgColor, UIColor(named: "HomeBackground3")?.cgColor]
...
//            tabHeaderUIView[i].backgroundColor = UIColor(named: "ColorHehe")
//        }
    ...
    func setTabSelected(_ index: Int) {
        for i in 0..<tabButtons.count {
            tabButtons[i].setBackgroundImage(UIImage(named: "NotSelectIcon"), for: .normal)
            //mau` cua tab
//            tabLabels[i].textColor = .white
        }
        
        //tabHeaderUIView[index].backgroundColor = .white
        tabButtons[index].setBackgroundImage(UIImage(named: "SelectedIcon"), for: .normal)
...
extension HomeViewController: UICollectionViewDataSource, CollectionViewWaterfallLayoutDelegate  {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.petAvatarImage.layer.cornerRadius = 0
